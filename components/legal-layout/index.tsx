...
export function LegalLayout({ children }: LegalLayoutProps) {
  return (
    <>
      ...
      <div className="grid grid-cols-12 gap-4 lg:gap-8 bd:container px-4 bt:px-10 bd:px-16 space-y-12 pt-8 pb-16">
        <div className="col-span-12 lg:col-span-4">
          <LegalTableOfContents />
        </div>
        <div className="col-span-12 lg:col-span-8 font-halenoir prose">{children}</div>
      </div>
    </>
  )
}
