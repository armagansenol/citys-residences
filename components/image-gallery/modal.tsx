...
export function ImageGalleryModal() {
  ...
  return (
    <Dialog defaultOpen={isOpen} open={isOpen} onOpenChange={(open) => !open && closeModal()}>
      <DialogContent className="w-screen h-screen min-h-screen min-w-screen min-w-none max-w-none p-0 box-shadow-none bg-transparent border-none flex items-center justify-center">
