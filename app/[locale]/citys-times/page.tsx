  ...
  return (
    <>
      ...
      <section className="flex">
        {/* Left Sidebar */}
        <div className="w-64 bg-bricky-brick text-white p-8 flex flex-col justify-center space-y-6 min-h-screen">
        ...
        <div className="flex-1 bg-white p-8">
          ...
          <div className="mb-8 flex flex-col items-center">
            <h3 className="text-6xl font-bold text-black mb-2">CITY&apos;S TIMES</h3>
            <div className="w-full h-0.5 bg-black mb-4"></div>
            <p className="text-bricky-brick text-4xl">Bizi Takip Edin...</p>
          </div>
          {/* Image Gallery */}
          <div className="grid grid-cols-3 gap-6 mb-8">
            <div className="h-64 bg-bricky-brick"></div>
          </div>
        </div>
      </section>
    </>
